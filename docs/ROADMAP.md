...
| ------------------------ | -------------------------------------- |
| Versión                  | 1.1                                    |
| Fecha base               | 11 de agosto de 2026                   |
| Estado                   | Fases 0 a 9 completadas                |
...
API NestJS
  |         |          |             |
  v         v          v             v
PostgreSQL  Redis      MinIO         Adaptadores externos
            + Worker   / S3          - WhatsApp Cloud API
                                      - Correo SMTP
                                      - Google Calendar
```

### Contenedores locales previstos

- `web`: aplicación web/PWA.
- `api`: API y reglas de negocio.
- `worker`: recordatorios y trabajos asíncronos.
...
### Fase 1 — Base Docker y sistema visual ✅
...
### Fase 2 — Identidad, seguridad y roles ✅

**Objetivo:** implementar acceso seguro para clientas, manicuristas y administradora.

Entregables:

- Clientas: teléfono internacional y contraseña.
...
- El modo `mock` permite probar todos los flujos sin credenciales externas.
...
### Fase 3 — Disponibilidad y agenda ✅
...
- Retención de horario durante 10 minutos.
...
### Fase 4 — Catálogo, calculadora y cotizaciones ✅
...
### Fase 5 — Visitas, camino de recompensas y promociones ✅
...
- Plazo de 10 minutos para subirlo.
...
### Fase 7 — Notificaciones e integraciones ✅
